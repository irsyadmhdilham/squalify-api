# Generated by Django 2.1.2 on 2019-03-13 04:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group_image', models.ImageField(default='no_image.jpeg', upload_to=apis._models.inbox.image_directory_path)),
            ],
        ),
        migrations.CreateModel(
            name='Inbox',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('api_token', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='authtoken.Token')),
                ('call_logs', models.ManyToManyField(blank=True, to='apis.CallLog')),
                ...
                ('fcm_token', models.ManyToManyField(blank=True, to='apis.FcmToken')),
        ...
        migrations.AddField(
            model_name='contact',
            name='status',
            field=models.ForeignKey(default='None', on_delete=django.db.models.deletion.CASCADE, to='apis.ContactStatus', to_field='name'),
        ),
        migrations.AddField(
            model_name='comment',
            name='commented_by',
        ...
        migrations.AddField(
            model_name='calllog',
            name='contact',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apis.Contact'),
        ),
        migrations.AddField(
            model_name='agency',
            name='company',
